...
.hero-section {
  ...
  overflow: hidden;
  background: linear-gradient(160deg, #090d16 0%, #0f172a 50%, #1e1b4b 100%);
  color: #ffffff;
}
...
/* ══════════════════════════════════════════════════════════════
   RESPONSIVE OVERRIDES (MOBILE & TABLET <= 768px)
   ══════════════════════════════════════════════════════════════ */
...
@media (max-width: 768px) {
  ...
  .faq-section, .features-section, .how-section, .cta-section {
    padding: 48px 16px;
  }
  .faq-question {
    padding: 16px 18px;
